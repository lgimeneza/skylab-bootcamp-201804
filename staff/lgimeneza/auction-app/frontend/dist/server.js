...
var _productTypes = __webpack_require__(8);
...
function getProduct(id) {
    return async function (dispatch, getState) {
        ...
        dispatch({ type: _productTypes.Types.UPDATE_PRODUCT, payload: { product: data } });
    };
}
...
var _productsTypes = __webpack_require__(9);
...
function getProducts() {
    return async function (dispatch, getState) {
        var _ref = await getProductsFromAPI(),
            data = _ref.data.data;

        dispatch({ type: _productsTypes.Types.UPDATE_PRODUCTS, payload: { products: data } });
    };
}
function getProductsFromAPI() {
    return _axios2.default.get('http://localhost:5000/api/product');
}
...
function productReducer() {
    ...
    switch (action.type) {
        case _productTypes.Types.UPDATE_PRODUCT:
...
function productsReducer() {
    ...
    switch (action.type) {
        case _productsTypes.Types.UPDATE_PRODUCTS:
