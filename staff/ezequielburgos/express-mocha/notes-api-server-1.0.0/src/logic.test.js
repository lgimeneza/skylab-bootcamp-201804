...
describe('logic (notes)', () => {
    ...
    describe('add note', () => {
        ...
        it('should throw error on empty text', () => {
            expect(() => logic.addNote('')).toThrowError('text is empty or blank')
        })
    ...
    describe('search notes', () => {
        ...
        it('should throw error on no text', () => {
            expect(() => logic.findNotes(123)).toThrowError('text is not a string')
        })

        it('should throw error on empty text', () => {
            expect(() => logic.findNotes('')).toThrowError('text is empty or blank')
        })
    })
})