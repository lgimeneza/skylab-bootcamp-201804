...
describe('logic (notes)', () => {
    ...
    describe('add note', () => {
        ...
        it('should add notes with different ids', () => {
            ...
            const id2 = logic.addNote(userId, 'my note 2')
            const id3 = logic.addNote(userId, 'my note 3')
            ...
            expect(note2.id).toBe(id2)
            expect(note3.id).toBe(id3)
        ...
        it('should throw error on no text', () => {
            expect(() => logic.addNote(userId,123)).toThrowError('text is not a string')
        })
    ...
    describe('retrieve note', () => {
        ...
        it('should throw error on no id', () => {
            expect(() => logic.retrieveNote(userId, 35436)).toThrowError('id is not a string')
        })
        ...
        it('should throw error on no userId', () => {
            expect(() => logic.retrieveNote(234, 'id')).toThrowError('userId is not a string')
        })
    ...
    describe('remove note', () => {
        ...
        it('should throw error on no id', () => {
            expect(() => logic.removeNote(userId,456)).toThrowError('id is not a string')
        })
        ...
        it('should throw error on no userId', () => {
            expect(() => logic.removeNote(234, 'id')).toThrowError('userId is not a string')
        })
