...
describe('logic (sweet-home)', () => {
    ...
    beforeEach(() => {
        ...
        userData = { name: 'Nur', surname: 'C', phone: '689456739', dni: '45629856L', password: '123', apartmentId: '23456789543' }
        dummyUserId = '123456781234567812345678'
        user = { name: 'Nuria', surname: 'C', phone: '689456739', dni: '666', password: '123' }
        user2 = { name: 'Eze', surname: 'C', phone: '689456739', dni: '777', password: '123' }
        ...
        describe('register user', () => {
            it('should succeed on correct data', () =>
                logic.registerUser('Nur', 'C', '689456739', '45629856L', '1234', '23456789543')
    ...
    //                 user.apartmentId = res._id
    //                 user2.apartmentId = res._id
    ...
    //                 .then((res) => {
    //                     console.log(res)
    //                     return Promise.all([logic.listUsers(res[0].apartmentId)])
    //                         .then(users => {
