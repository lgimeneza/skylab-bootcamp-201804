...
describe('logic (calculator)', function() {
    ...
    it('should 30.6 * 0.5 + 2 = 15.3', function() {
        calc.three()
        expect(calc.status()).toBe(3)
        ...
        calc.five()
        expect(calc.status()).toBe(0.5)

        calc.sum()
        expect(calc.status()).toBe(15.3)

        calc.two()
        expect(calc.status()).toBe(2)

        calc.equal()
        expect(calc.status()).toBe(17.3)
    })

    
    it('should 1 + 1 = (2) + 1 = 3', function() {
        calc.one()
        expect(calc.status()).toBe(1)
    ...
    it('should 1 + 1 = (2) 1 + 1 = (2)', function() {
        calc.one()
        expect(calc.status()).toBe(1)
